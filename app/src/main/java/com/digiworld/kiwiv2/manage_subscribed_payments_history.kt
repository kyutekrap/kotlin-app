...
class manage_subscribed_payments_history : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_manage_subscribed_payments_history)
        ...
        if (extras != null) {
            ...
            if (extras.containsKey("recipient") && extras.containsKey("address")) {
        ...
        with(mURL.openConnection() as HttpURLConnection) {
            ...
            BufferedReader(InputStreamReader(inputStream)).use {
                ...
                if (jsonObj.getString("success") == "false") {
                    ...
                    startActivity(Intent(applicationContext, manage_subscribedPayments::class.java))
                }
            }
        }
    }
