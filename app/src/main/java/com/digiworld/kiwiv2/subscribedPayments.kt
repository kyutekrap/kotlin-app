...
class subscribedPayments : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_subscribed_payments)
        ...
        add.setOnClickListener {
            startActivity(Intent(this, subscribed_payments_add::class.java))
        }
        ...
        try {
            ...
            val adapter = manage_subscribedPayments_Adapter(subscribedPaymentsList, this, "")
    ...
    private fun loadPayments(username: String) {
        val reqParam = URLEncoder.encode("username", "UTF-8") + "=" + URLEncoder.encode(username, "UTF-8")
        val mURL = URL("https://www.dongkye.tech/A5/subscribed_payments.php")
